...
export default function NewArtGalleryPage() {
    ...
    const { data: heroImages, isLoading: heroLoading } = useHeroImages('new-arrivals');
    ...
    return (
        <div className="min-h-screen  premium-bg">
            ...
            <h1 className="text-center custom-heading">
                Explore <span className="text-gradient-teal">New Arts</span>
            </h1>
             </section>
            ...
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="flex gap-8 items-stretch">
                    ...
                    <div className={`hidden lg:block lg:w-64 lg:flex-shrink-0`}>
                        ...
                        {/* Filter Panel */}
                        <div
                            className="max-lg:fixed max-lg:inset-0 max-lg:overflow-y-auto max-lg:top-0
                lg:rounded-lg max-lg:rounded-none shadow-2xl flex flex-col z-20 custom-scrollbar
